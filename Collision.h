...
public:
    ...
    //static bool chestCollision(const std::vector<Chest<Item>> &itemChest_vector, const std::vector<Chest<Weapon>> &weaponChest_vector, Enemy *enemy, int x, int y );//enemy collision with chests
